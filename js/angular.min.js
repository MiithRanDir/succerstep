...
(function(x) {
    ...
    var ag = /-([a-z])/g,
        ...
        ha = { option: [1, '<select multiple="multiple">', "</select>"], thead: [1, "<table fixed-header>", "</table>"], col: [2, "<table fixed-header><colgroup>", "</colgroup></table>"], tr: [2, "<table fixed-header><tbody>", "</tbody></table>"], td: [3, "<table fixed-header><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""] };
